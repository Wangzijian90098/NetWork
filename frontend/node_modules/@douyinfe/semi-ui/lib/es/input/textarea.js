...
class TextArea extends BaseComponent {
  constructor(props) {
    ...
    this.lineNumberRef = /*#__PURE__*/React.createRef();
  ...
  render() {
    const _a = this.props,
      ...
      rest = __rest(_a, ["autosize", "placeholder", "onEnterPress", "onResize", "disabled", "readonly", "className", "showCounter", "validateStatus", "maxCount", "defaultValue", "style", "textareaStyle", "forwardRef", "getValueLength", "maxLength", "minLength", "showClear", "borderless", "autoFocus", "showLineNumber", "lineNumberStart", "lineNumberClassName", "lineNumberStyle"]);
    const {
      isFocus,
      value,
    ...
    }, this.renderLineNumbers(), showLineNumber ? (/*#__PURE__*/React.createElement("div", {
...
TextArea.defaultProps = {
  ...
  onResize: _noop,
  onClear: _noop,
  onCompositionStart: _noop,
  onCompositionEnd: _noop,
  onCompositionUpdate: _noop,
