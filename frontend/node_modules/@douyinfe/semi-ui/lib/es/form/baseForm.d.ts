...
declare class Form<Values extends Record<string, any> = any> extends BaseComponent<BaseFormProps<Values>, BaseFormState> {
    ...
    static Select: React.ComponentType<import("utility-types").Subtract<{
        ...
        defaultValue?: any[] | import("../select").BasicSelectValue;
        value?: any[] | import("../select").BasicSelectValue;
        placeholder?: React.ReactNode;
        onChange?: (value: any[] | import("../select").BasicSelectValue) => void;
        multiple?: boolean;
        ...
        insetLabelId?: string;
        inputProps?: Omit<import("../input").InputProps, keyof {
        ...
        remote?: boolean;
        onDeselect?: (value: any[] | import("../select").BasicSelectValue, option: Record<string, any>) => void;
        onSelect?: (value: any[] | import("../select").BasicSelectValue, option: Record<string, any>) => void;
        allowCreate?: boolean;
    ...
    static PinCode: React.ComponentType<import("utility-types").Subtract<import("../pincode").PinCodeProps, import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & React.RefAttributes<any>>;
