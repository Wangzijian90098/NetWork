...
declare const FormSelect: import("react").ComponentType<import("utility-types").Subtract<{
    ...
    defaultValue?: any[] | import("../select/index").BasicSelectValue;
    value?: any[] | import("../select/index").BasicSelectValue;
    placeholder?: import("react").ReactNode;
    onChange?: (value: any[] | import("../select/index").BasicSelectValue) => void;
    multiple?: boolean;
    ...
    zIndex?: number;
    position?: "top" | "left" | "right" | "bottom" | "topLeft" | "topRight" | "leftTop" | "leftBottom" | "rightTop" | "rightBottom" | "bottomLeft" | "bottomRight" | "leftTopOver" | "rightTopOver" | "leftBottomOver" | "rightBottomOver";
    ...
    insetLabelId?: string;
    inputProps?: Omit<import("../input/index").InputProps, keyof {
    ...
    remote?: boolean;
    onDeselect?: (value: any[] | import("../select/index").BasicSelectValue, option: Record<string, any>) => void;
    onSelect?: (value: any[] | import("../select/index").BasicSelectValue, option: Record<string, any>) => void;
    allowCreate?: boolean;
...
} & Pick<import("../tooltip").TooltipProps, "stopPropagation" | "motion" | "getPopupContainer" | "spacing" | "mouseEnterDelay" | "autoAdjustOverflow" | "mouseLeaveDelay"> & import("./interface").CommonFieldProps, import("./interface").CommonexcludeType>> & import("./interface").SelectStatic;
...
declare const FormPinCode: import("react").ComponentType<import("utility-types").Subtract<import("../pincode/index").PinCodeProps, import("./interface").CommonexcludeType> & import("./interface").CommonFieldProps & import("react").RefAttributes<any>>;
export { FormInput, FormInputNumber, FormTextArea, FormSelect, FormCheckboxGroup, FormCheckbox, FormRadioGroup, FormRadio, FormDatePicker, FormSwitch, FormSlider, FormTimePicker, FormTreeSelect, FormCascader, FormRating, FormAutoComplete, FormUpload, FormTagInput, FormPinCode };
