...
declare class Table<RecordType extends Record<string, any>> extends BaseComponent<NormalTableProps<RecordType>, NormalTableState<RecordType>> {
    ...
    handleRowClickSelection: (rowKey: BaseRowKeyType, selected: boolean, e: React.MouseEvent) => void;
    ...
    mergePagination: (pagination: TablePaginationProps) => {
        ...
        popoverPosition?: "top" | "left" | "right" | "bottom" | "topLeft" | "topRight" | "leftTop" | "leftBottom" | "rightTop" | "rightBottom" | "bottomLeft" | "bottomRight" | "leftTopOver" | "rightTopOver" | "leftBottomOver" | "rightBottomOver";
