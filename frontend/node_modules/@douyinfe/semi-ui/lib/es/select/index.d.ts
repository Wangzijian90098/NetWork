...
type IsDefaultSelectGeneric<T> = [T] extends [BasicSelectValue] ? ([BasicSelectValue] extends [T] ? true : false) : false;
/**
 * Select's value type.
 ...
 */
export type SelectValue<T = BasicSelectValue> = IsDefaultSelectGeneric<T> extends true ? (BasicSelectValue | any[] | undefined) : (T | T[] | undefined);
...
declare class Select<T = BasicSelectValue> extends BaseComponent<SelectProps<T>, SelectState> {
    ...
    static propTypes: {
        ...
        position: PropTypes.Requireable<"top" | "left" | "right" | "bottom" | "topLeft" | "topRight" | "leftTop" | "leftBottom" | "rightTop" | "rightBottom" | "bottomLeft" | "bottomRight" | "leftTopOver" | "rightTopOver" | "leftBottomOver" | "rightBottomOver">;
