...
class Cascader extends _baseComponent.default {
  constructor(props) {
    ...
    this.renderMultipleTags = () => {
      ...
      const realKeys = this.mergeType === _constants.strings.NONE_MERGE_TYPE || checkRelation === _constants.strings.UN_RELATED ? checkedKeys : resolvedCheckedKeys;
      const displayTag = [];
      const hiddenTag = [];
...
Cascader.defaultProps = (0, _utils.getDefaultPropsFromGlobalConfig)(Cascader.__SemiComponentName__, {
  ...
  checkRelation: _constants.strings.RELATED
});
