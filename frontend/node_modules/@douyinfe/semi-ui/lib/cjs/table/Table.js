...
class Table extends _baseComponent.default {
  get adapter() {
    ...
    return Object.assign(Object.assign({}, super.adapter), {
      resetScrollY: () => {
        ...
        const hasScrollY = Boolean((0, _get2.default)(scroll, 'y'));
        if (hasScrollY) {
  ...
  constructor(props, context) {
    ...
    this.addFnsInColumn = function () {
      ...
      if (column && (column.sorter || column.filters || column.onFilter || column.useFullRender)) {
        ...
        let hasFilter = Array.isArray(column.filters) && column.filters.length || /*#__PURE__*/(0, _react.isValidElement)(column.filterDropdown) || typeof column.renderFilterDropdown === 'function';
    ...
    this.handleRowClickSelection = (rowKey, selected, e) => {
      const {
        rowSelection
      } = this.state;
      const clickRowEnabled = (0, _get2.default)(rowSelection, 'clickRow', false);
      if (clickRowEnabled && rowSelection) {
        const disabled = (0, _get2.default)(rowSelection, 'disabled', false);
        ...
        const record = this.cachedFilteredSortedDataSource.find(r => this.foundation.getRecordKey(r) === rowKey);
    ...
    this.mergePagination = pagination => {
      const userOnChange = pagination === null || pagination === void 0 ? void 0 : pagination.onChange;
      const {
        scroll
      } = this.props;
      const scrollToFirstRowOnChange = (0, _get2.default)(scroll, 'scrollToFirstRowOnChange');
      ...
      if (scrollToFirstRowOnChange) {
        const newPagination = Object.assign(Object.assign({}, pagination), {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", Object.assign({
      ...
      style: wrapStyle,
      id: id
    }, dataAttr), /*#__PURE__*/_react.default.createElement(_TableContextProvider.default, Object.assign({}, tableContextValue, {
