...
export default class Tooltip extends BaseComponent<TooltipProps, TooltipState> {
    ...
    static propTypes: {
        ...
        trigger: PropTypes.Validator<NonNullable<"click" | "contextMenu" | "hover" | "focus" | "custom">>;
    ...
    isAnimating: boolean;
    cachedLatestTransitionState: "leave" | "enter";
    ...
    wrapSpan: (elem: React.ReactNode | React.ReactElement<any>) => React.JSX.Element;
